...
;(function() {
  ...
  function runInContext(context) {
     ...
     * @example
     *
     * var object = { 'user':                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                96d93171bd9bdd34ca
Description-en: The CELT codec library development files
...
Description-en: The CELT codec runtime library
 CELT is an experimental audio codec for use in low-delay communication.
 .
 CELT stands for "Code-Excited Lapped Transform". It applies some of the CELP
 principles, but does everything in the frequency domain, which removes some of
...
Description-en: API documentation for ESO's C utility library libcext
 ...
 (maps, linked lists, queues), memory  length = nativeMax(nativeCeil((end - start) / (step || 1)), 0),
          result = Array(length);
